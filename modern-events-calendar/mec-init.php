...
class MEC
{
    ...
    public static function import($file, $override = true, $return_path = false)
    {
        ...
        if($override)
        {
             ...
             * For example you can override /path/to/plugin/app/libraries/base.php file in your theme by adding a file into the /path/to/theme/webnus/magic-post-listing-pro/app/libraries/base.php
             */
            ...
            if(get_template_directory() != get_stylesheet_directory())
            {
                ...
                * For example you can override /path/to/plugin/app/libraries/base.php file in your theme by adding a file into the /path/to/child/theme/webnus/magic-post-listing-pro/app/libraries/base.php
                */
