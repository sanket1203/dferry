...
(function($)
{
    $.fn.mecFullCalendar = function(options)
    {
        ...
        function loadSkin(skin)
        {
            ...
            // Add loader
            $("#mec_full_calendar_container_"+settings.id).append('<div class="mec-month-navigator-loading"></div>')
            $.ajax(
            {
                url: settings.ajax_url,
                ...
                success: function(response)
                {
                    ...
                    // Remove loader
                    $("#mec_full_calendar_container_"+settings.id).remove(".mec-month-navigator-loading");
                },
                error: function()
                {
                }
...
(function($)
{
    $.fn.mecListView = function(options)
    {
        ...
        function setListeners()
        {
            ...
            // accardione toggle
            $(document).on('click', '.mec-toggle-item-inner', function(event)
            {
                var $this = $(this);
                event.preventDefault();
