...
class MEC_skin_list extends MEC_skins
{
    ...
    public function initialize($atts)
    {
        ...
        $this->date_format_standard_1 = (isset($this->skin_options['accordion_date_format1']) and trim($this->skin_options['accordion_date_format1'])) ? $this->skin_options['accordion_date_format1'] : 'd M';
