    ...
    <?php
        ...
        for($list_day = 1; $list_day <= $days_in_month; $list_day++)
        {
            ...
            if(isset($events[$today]) and count($events[$today]))
            {
                ...
                //echo "<pre>"; print_r($selected_day); echo "</pre>"; die('Selected day from caldender');
            ...
            {
                // echo "<h2> Hello tester </h2>"; 
               // echo "<pre>"; print_r($selected_day); echo "</pre>"; die('else Selected day from caldender');
