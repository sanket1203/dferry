...
//echo $current_month_time; die("calender view of this m");
    ...
    <div class="mec-calendar <?php echo $cal_style; ?>">
        ...
        <div class="mec-calendar-side mec-clear">
            ...
            <div class="mec-calendar-table" id="mec_skin_events_<?php echo $this->id; ?>">
                <div class="mec-month-container mec-month-container-selected" id="mec_monthly_view_month_<?php echo $this->id; ?>_<?php echo date('Ym', $current_month_time); ?>" data-month-id="<?php echo date('Ym', $current_month_time); ?>"><?php echo $month_html; ?>
                     <?php //echo date('Ymd', $current_month_time); ?>             
                </div>
            </div>
        </div>
