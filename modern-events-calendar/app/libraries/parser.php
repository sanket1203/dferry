...
class MEC_parser extends MEC_base
{
    ...
    public function template($template)
    {
        ...
        elseif(is_post_type_archive($PT))
        {
            ...
            $this->factory->filter('the_content', array($this, 'archive_content'));
            $this->factory->filter('mec_archive_title', array($this, 'archive_title'));
            $this->factory->filter('post_thumbnail_html', array($this, 'archive_thumbnail'));
		}
