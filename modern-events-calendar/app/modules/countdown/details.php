...
$end_date = (isset($date['end']) and isset($date['end']['date'])) ? $date['end']['date'] : date('Y-m-d H:i:s');
...
$start_time = date('D M j Y G:i:s', strtotime($start_date.' '.date('H:i:s', strtotime($s_time))));
$end_time = date('D M j Y G:i:s', strtotime($end_date.' '.date('H:i:s', strtotime($e_time))));
